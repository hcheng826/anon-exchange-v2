// Generated by @wagmi/cli@0.1.15 on 8/24/2023 at 11:52:28 PM
import {
  getContract,
  GetContractArgs,
  readContract,
...
export function getAnonExchange(config: Omit<GetContractArgs, 'abi' | 'address'> & { chainId?: keyof typeof anonExchangeAddress }) {
  return getContract({ abi: anonExchangeABI, address: anonExchangeAddress[31337], ...config })
}
...
export function readAnonExchange<TAbi extends readonly unknown[] = typeof anonExchangeABI, TFunctionName extends string = string>(
  ...
  return readContract({ abi: anonExchangeABI, address: anonExchangeAddress[31337], ...config } as unknown as ReadContractConfig<TAbi, TFunctionName>)
}
...
>(
  ...
  return writeContract({ abi: anonExchangeABI, address: anonExchangeAddress[31337], ...config } as WriteContractArgs<
    typeof anonExchangeABI,
    TFunctionName
  >)
}
...
export function prepareWriteAnonExchange<TAbi extends readonly unknown[] = typeof anonExchangeABI, TFunctionName extends string = string>(
  ...
  return prepareWriteContract({ abi: anonExchangeABI, address: anonExchangeAddress[31337], ...config } as unknown as PrepareWriteContractConfig<
    TAbi,
    TFunctionName
  >)
}
...
export function getSimpleNft(config: Omit<GetContractArgs, 'abi' | 'address'> & { chainId?: keyof typeof simpleNftAddress }) {
  return getContract({ abi: simpleNftABI, address: simpleNftAddress[31337], ...config })
}
...
export function readSimpleNft<TAbi extends readonly unknown[] = typeof simpleNftABI, TFunctionName extends string = string>(
  ...
  return readContract({ abi: simpleNftABI, address: simpleNftAddress[31337], ...config } as unknown as ReadContractConfig<TAbi, TFunctionName>)
}
...
>(
  ...
  return writeContract({ abi: simpleNftABI, address: simpleNftAddress[31337], ...config } as WriteContractArgs<typeof simpleNftABI, TFunctionName>)
}
...
export function prepareWriteSimpleNft<TAbi extends readonly unknown[] = typeof simpleNftABI, TFunctionName extends string = string>(
  ...
  return prepareWriteContract({ abi: simpleNftABI, address: simpleNftAddress[31337], ...config } as unknown as PrepareWriteContractConfig<
    TAbi,
    TFunctionName
  >)
}
...
export function watchSimpleNftEvent<TAbi extends readonly unknown[] = typeof simpleNftABI, TEventName extends string = string>(
  ...
  return watchContractEvent(
    { abi: simpleNftABI, address: simpleNftAddress[31337], ...config } as WatchContractEventConfig<TAbi, TEventName>,
    callback
  )
}
...
export function getSemaphore(config: Omit<GetContractArgs, 'abi' | 'address'> & { chainId?: keyof typeof semaphoreAddress }) {
  return getContract({ abi: semaphoreABI, address: semaphoreAddress[31337], ...config })
}
...
export function readSemaphore<TAbi extends readonly unknown[] = typeof semaphoreABI, TFunctionName extends string = string>(
  ...
  return readContract({ abi: semaphoreABI, address: semaphoreAddress[31337], ...config } as unknown as ReadContractConfig<TAbi, TFunctionName>)
}
...
>(
  ...
  return writeContract({ abi: semaphoreABI, address: semaphoreAddress[31337], ...config } as WriteContractArgs<typeof semaphoreABI, TFunctionName>)
}
...
export function prepareWriteSemaphore<TAbi extends readonly unknown[] = typeof semaphoreABI, TFunctionName extends string = string>(
  ...
  return prepareWriteContract({ abi: semaphoreABI, address: semaphoreAddress[31337], ...config } as unknown as PrepareWriteContractConfig<
    TAbi,
    TFunctionName
  >)
}
...
export function watchSemaphoreEvent<TAbi extends readonly unknown[] = typeof semaphoreABI, TEventName extends string = string>(
  ...
  return watchContractEvent(
    { abi: semaphoreABI, address: semaphoreAddress[31337], ...config } as WatchContractEventConfig<TAbi, TEventName>,
    callback
  )
}
