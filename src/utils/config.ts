...
import { localhost, sepolia, mantleTestnet, scrollSepolia, polygonMumbai } from '@wagmi/chains'
...
export const supportedChains = [localhost, sepolia, mantleTestnet, scrollSepolia, polygonMumbai]
